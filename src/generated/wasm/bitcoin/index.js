 ...
 * @returns {any}
 */
export function search_bitcoin_batch(prefix, suffix, batch_size, address_type) {
    ...
    const ret = wasm.search_bitcoin_batch(ptr0, len0, ptr1, len1, batch_size, ptr2, len2);
    if (ret[2]) {
